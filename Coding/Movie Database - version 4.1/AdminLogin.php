...
<html>
		...
		<input type="submit" name="submit" value="Show user" data-toggle='tooltip'title='Click to show all users'> <!--This a button to show all member who subscribed-->
		</fieldset>		
		</form>	
		<br>
		<fieldset>
		...
		<br>		
		<input type="submit" name="submit" value="Remove" data-toggle='tooltip'title='Click to remove user'/> <!--This a button to remove member who unsubscribed-->
		</div>
		</form>
		</fieldset>
		</html>
