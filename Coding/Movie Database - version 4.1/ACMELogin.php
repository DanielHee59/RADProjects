...
<html>
		...
		<input type="submit" name="submit" value="Show Like"  data-toggle='tooltip'title='Click to view live analytic for like'> <!--This a button to show like bargraph-->
		</fieldset>		
		</form>	
		<br>	
		...
		<input type="submit" name="submit" value="Show dislike"  data-toggle='tooltip'title='Click to view live analytic for dislike'> <!--This a button to show dislike bargraph-->
		</fieldset>		
		</form>		
		</html>
<?php
